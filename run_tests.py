...
t(
    ...
    cmd(
        "adjust_curves",
        {"image_index": 0, "channel": "value", "points": [0, 0, 128, 148, 255, 255]},
    ),
)
t(
    "brightness",
    cmd("adjust_brightness_contrast", {"image_index": 0, "brightness": 10, "contrast": 5}),
)
t(
    "hue_sat",
    cmd("adjust_hue_saturation", {"image_index": 0, "hue": 5, "saturation": 10, "lightness": 0}),
)
t(
    "color_balance",
    cmd(
        "adjust_color_balance",
        {"image_index": 0, "cyan_red": 10, "magenta_green": 0, "yellow_blue": -10},
    ),
)
...
t(
    "crop_to_rect",
    cmd("crop_to_rect", {"image_index": 0, "x": 0, "y": 0, "width": 100, "height": 100}),
)
...
t(
    ...
    cmd(
        "resize_canvas",
        {"image_index": 0, "width": 120, "height": 120, "offset_x": 0, "offset_y": 0},
    ),
)
...
t(
    "select_rect",
    cmd("select_rectangle", {"image_index": 0, "x": 10, "y": 10, "width": 40, "height": 40}),
)
t(
    "select_ellipse",
    cmd("select_ellipse", {"image_index": 0, "x": 10, "y": 10, "width": 40, "height": 40}),
)
...
chk(
    "select_color_nonempty",
    _sel.get("results", {}).get("has_selection") is True,
    _sel.get("results"),
)
...
t(
    "create_layer",
    cmd("create_layer", {"image_index": 0, "name": "TLayer", "width": 80, "height": 80}),
)
...
t(
    "reorder_layer",
    cmd("reorder_layer", {"image_index": 0, "layer_name": "Renamed", "new_position": 0}),
)
...
t(
    ...
    cmd(
        "draw_line",
        {"image_index": 0, "x1": 0, "y1": 0, "x2": 50, "y2": 50, "color": "#000000", "width": 2},
    ),
)
t(
    "draw_rect",
...
t(
    ...
    cmd(
        "fill_rectangle",
        {"image_index": 0, "x": 5, "y": 5, "width": 20, "height": 20, "color": "#ffff00"},
    ),
)
t(
    "fill_ellipse",
    cmd(
        "fill_ellipse",
        {"image_index": 0, "x": 5, "y": 5, "width": 20, "height": 20, "color": "#ff00ff"},
    ),
)
...
t(
    ...
    cmd(
        "add_text",
        {"image_index": 0, "text": "Hello", "x": 10, "y": 10, "size": 12, "color": "#000000"},
    ),
)
