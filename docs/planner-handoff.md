...
**0027 GoldenPathDemoAndSmoke (Completed — PR #42 / main@e96213a):**
...
non-status asserts (**H3**). Shipped: **`docs/golden-path.md#golden-path`**,
**`scripts/golden_path_smoke.py`** (default dry-run / `--live`), offline structure
+ behavioral tests, optional `@integration` + `GIMP_MCP_LIVE=1`, jailed out-dir
...
**0030 Completed (2026-08-05; PR #45 / main@6c38194):** Default HL can select but not
clear to transparent. **Shipped:** `get_selection_bounds` (HL, **single-tag**, handle-aware
